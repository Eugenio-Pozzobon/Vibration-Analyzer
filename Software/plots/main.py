...
paths = [
    # "./teste_semPeso_semVento",
    # "./teste_idem_comAperto",
    # "./teste_idem_graxa",
    # "./fullSpeed",
    # "./halfstepper",
    # "./halfStepperFull",
    # "./halfStepperFull_2",
    # "./halfStepperFull+SPEED",
    # "./halfStepperFull+SPEED2",
    # "./halfStepper+borracha",
    # "./testeHalfStep+borracha+speedCorrigido",
    #"./log_constancia_1",
    #"./log_constancia_2"
    #"./barra cortada",
    #"./barra cortada v2",
    #"./borrachas_especiais + camera",
    "./borrachas_especiais sem camera",
]
